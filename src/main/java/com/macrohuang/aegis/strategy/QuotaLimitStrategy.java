...
public class QuotaLimitStrategy extends TimeLimitStrategy {
    ...
    /* (non-Javadoc)
     * @see com.macrohuang.aegis.strategy.AbstractLimitStrategy#getLimit(java.lang.Object[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.macrohuang.aegis.strategy.TimeLimitStrategy#getAccessCount(java.lang.Object[])
     */
    @Override
